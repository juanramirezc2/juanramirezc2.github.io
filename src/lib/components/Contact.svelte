<script lang="ts">
  const contacts = [
    {
      label: 'Email',
      href: 'mailto:hello@juangramirez.dev',
      text: 'hello@juangramirez.dev',
    ...
    {
      label: 'GitHub',
      href: 'https://github.com/juanramirezc2',
      text: 'github.com/juanramirezc2',
...
<section id="contact">
  <div class="container">
    <div class="glass-card">
      ...
      <footer>
        <p>&copy; {new Date().getFullYear()} Juan Ramirez. All rights reserved.</p>
      </footer>
    </div>
  </div>
</section>
